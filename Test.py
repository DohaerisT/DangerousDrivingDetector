...
net.load_state_dict(torch.load('./weights/sAndc_20200221_VOC_10000.pth',map_location=lambda storage, loc: storage))
img_id = 1
name='calling_test14'
image = cv2.imread('E:/bigcreate/Fatigue-Driven-Detection-Based-on-CNN/dataset/JPEGImages/1315.jpg', cv2.IMREAD_COLOR)
